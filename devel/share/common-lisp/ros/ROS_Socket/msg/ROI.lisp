...
(cl:defmethod cl:initialize-instance :after ((m <ROI>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ROI)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name ROS_Socket-msg:<ROI> is deprecated: use ROS_Socket-msg:ROI instead.")))

(cl:ensure-generic-function 'object_name-val :lambda-list '(m))
(cl:defmethod object_name-val ((m <ROI>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ROS_Socket-msg:object_name-val is deprecated.  Use ROS_Socket-msg:object_name instead.")
  (object_name m))

(cl:ensure-generic-function 'score-val :lambda-list '(m))
(cl:defmethod score-val ((m <ROI>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ROS_Socket-msg:score-val is deprecated.  Use ROS_Socket-msg:score instead.")
  (score m))

(cl:ensure-generic-function 'min_x-val :lambda-list '(m))
(cl:defmethod min_x-val ((m <ROI>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ROS_Socket-msg:min_x-val is deprecated.  Use ROS_Socket-msg:min_x instead.")
  (min_x m))

(cl:ensure-generic-function 'Max_x-val :lambda-list '(m))
(cl:defmethod Max_x-val ((m <ROI>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ROS_Socket-msg:Max_x-val is deprecated.  Use ROS_Socket-msg:Max_x instead.")
  (Max_x m))

(cl:ensure-generic-function 'min_y-val :lambda-list '(m))
(cl:defmethod min_y-val ((m <ROI>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ROS_Socket-msg:min_y-val is deprecated.  Use ROS_Socket-msg:min_y instead.")
  (min_y m))

(cl:ensure-generic-function 'Max_y-val :lambda-list '(m))
(cl:defmethod Max_y-val ((m <ROI>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ROS_Socket-msg:Max_y-val is deprecated.  Use ROS_Socket-msg:Max_y instead.")
  (Max_y m))
