...
(cl:defclass <ROI_array> (roslisp-msg-protocol:ros-message)
  ((ROI_list
    :reader ROI_list
    :initarg :ROI_list
    :type (cl:vector ROS_Socket-msg:ROI)
   :initform (cl:make-array 0 :element-type 'ROS_Socket-msg:ROI :initial-element (cl:make-instance 'ROS_Socket-msg:ROI))))
)
...
(cl:defmethod cl:initialize-instance :after ((m <ROI_array>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ROI_array)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name ROS_Socket-msg:<ROI_array> is deprecated: use ROS_Socket-msg:ROI_array instead.")))

(cl:ensure-generic-function 'ROI_list-val :lambda-list '(m))
(cl:defmethod ROI_list-val ((m <ROI_array>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ROS_Socket-msg:ROI_list-val is deprecated.  Use ROS_Socket-msg:ROI_list instead.")
  (ROI_list m))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <ROI_array>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'ROI_list)))
    ...
    (cl:setf (cl:aref vals i) (cl:make-instance 'ROS_Socket-msg:ROI))
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<ROI_array>)))
  ...
  (cl:format cl:nil "ROI[] ROI_list~%~%================================================================================~%MSG: ROS_Socket/ROI~%string object_name~%float32 score~%int32 min_x~%int32 Max_x~%int32 min_y~%int32 Max_y~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'ROI_array)))
  "Returns full string definition for message of type 'ROI_array"
  (cl:format cl:nil "ROI[] ROI_list~%~%================================================================================~%MSG: ROS_Socket/ROI~%string object_name~%float32 score~%int32 min_x~%int32 Max_x~%int32 min_y~%int32 Max_y~%~%~%"))
