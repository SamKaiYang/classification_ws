...
def MotionItem(ItemNo):
    ...
    if MoveFlag == True:
        if LinePtpFlag == False:
            ...
            ArmTask.strategy_client_Arm_Mode(2,1,0,SpeedValue,2)#action,ra,vel,both
            ...
            print('x: ',pos.x,' y: ',pos.y,' z: ',pos.z,' pitch: ',pos.pitch,' roll: ',pos.roll,' yaw: ',pos.yaw)
            ArmTask.strategy_client_Arm_Mode(3,1,0,SpeedValue,2)#action,ra,vel,both
            ArmTask.strategy_client_pos_move(pos.x,pos.y,pos.z,pos.pitch,pos.roll,pos.yaw)
    #action: ptp line
    #ra : abs rel
    #grip 夾爪
...
if __name__ == '__main__':
    ...
    arm_state_server()
    ArmTask.strategy_client_Arm_Mode(0,1,0,20,2)#action,ra,vel,both
    while 1:
        Mission_Trigger()
