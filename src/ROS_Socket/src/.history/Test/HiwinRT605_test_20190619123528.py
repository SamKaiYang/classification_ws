...
def Execute_Mission():
    ...
    print("strategy :" ,strategy.state_flag.Strategy_feedback)
    print("state  :" ,strategy.state_flag.Arm_feedback)
    if strategy.state_flag.Arm_feedback == 0 and strategy.state_flag.Strategy_feedback == 1:
        strategy.state_flag.Strategy_feedback = 0
